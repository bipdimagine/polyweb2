...
sub _build_package {
    return 'NoSQL::__Anonymous__::Class' . $serial->();
}
...
sub become_Schema {
    ...
    $self->package_meta->superclasses( 'NoSQL::ClassScaffold::Schema' );
    return $self;
}
...
sub become_ResultClass {
    ...
    $self->push_ISA( 'NoSQL::ClassScaffold::ResultClass' );
    return $self;
}
...
package NoSQL::ClassScaffold::Schema;
...
package NoSQL::ClassScaffold::ResultClass;
