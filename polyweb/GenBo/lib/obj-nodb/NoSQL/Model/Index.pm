...
sub _build_result_class_scaffold { return NoSQL::ClassScaffold->new->become_ResultClass }
...
sub search {
    ...
    my $search = NoSQL::Search->new( model => $self->model );
